...
Pod::Spec.new do |s|
  s.name             = 'NativeScriptAlarm'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NativeScriptAlarm.'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source_files = 'NativeScriptAlarm/**/*.{swift}'
  ...
  #s.source_files = '*.{h,m}'
  s.resources = 'NativeScriptAlarm/**/*.{png,jpeg,jpg,storyboard,xib,xcassets,mp3}'
  s.resource_bundles = {
    'Assets' => ['NativeScriptAlarm/**/*.{png,jpeg,jpg,storyboard,xib,xcassets,mp3}']
  }
